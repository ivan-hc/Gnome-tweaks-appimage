...
LIBSAVED="crypto gdk-pixbuf gtk libpango libbrotlicommon libjson libXau libXdmcp libicudata libadwaita libnghttp libidn libssh libpsl libgssapi \
libunistring libkrb libGL libp11 libtasn libhogweed png python svg $lib_audio_keywords $lib_browser_launcher"
